...
// **************************Modif d'une quantité de produit*******************
function modifyQtt() {
...
function deleteProduct() {
    ...
    for (let j = 0; j < btn_supprimer.length; j++){
        btn_supprimer[j].addEventListener("click" , (event) => {
            ...
            //***********************element à supprimer en fonction de son id ET sa couleur***************************
...
function getForm() {
    ...
    //**********************POUR LE MAIL emailregex.com  POUR UN PASSWORD CI BESOIN regexlib.com ****************************************
